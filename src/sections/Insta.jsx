...
const Insta = () => {
  ...
  return (
    <div className="w-full lg:px-20 px-5 py-[80px] bg-white flex flex-col justify-center items-center gap-4">
      <h1 data-aos="zoom-in" data-aos-delay="100" className="text-[var(--themepurple)] text-xl font-semibold capitalize">Our instagram Shop</h1>
      ...
      className="bg-[var(--themepurple)] hover:bg-[var(--themeyellow)] text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-12 uppercase">#ElectraShop</button>
    </div>
  )
}
